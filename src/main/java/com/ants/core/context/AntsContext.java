...
import com.ants.common.annotation.boot.DbConfiguration;
import com.ants.common.annotation.boot.DbSource;
...
import com.ants.core.handler.RenderHandler;
import com.ants.core.module.*;
import com.ants.core.utils.ScanUtil;
import com.ants.plugin.cache.EhCachePlugin;
import com.ants.plugin.cache.RedisPlugin;
import com.ants.plugin.db.*;
import com.ants.plugin.jms.ActiveMqPlugin;
import com.ants.plugin.jms.ConsumerManager;
import com.ants.plugin.jms.JmsListener;
import com.ants.plugin.scheduler.FixedDelay;
import com.ants.plugin.scheduler.SchedulerBean;
import com.ants.plugin.scheduler.SchedulerManager;
import com.ants.plugin.sqlmap.SqlMapPlugin;
